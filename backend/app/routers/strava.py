...
from app.models import Route, StravaToken
...
def upload_to_strava(
    ...
    fit = encode_rowing_activity(
        workout.started_at, workout.samples, summary, route_waypoints=route.waypoints if route else None
    )
